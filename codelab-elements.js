(function () {
        ...
        function da(a, c, b, f, e) {
          ...
          switch (c.charAt(0)) {
            case "G":
              return (
                (b = 0 < f.getFullYear() ? 1 : 0), 4 <= d ? a.a.D[b] : a.a.F[b]
              );
            case "y":
              return (
                (b = f.getFullYear()),
            ...
            case "Q":
              return (
                (b = Math.floor(f.getMonth() / 3)), 4 > d ? a.a.K[b] : a.a.I[b]
              );
            case "d":
                ...
                L(
                  ...
                  D(
                    Math.floor(
                      Math.round(
                        (b -
                          new Date(new Date(b).getFullYear(), 0, 1).valueOf()) /
                          864e5
                      ) / 7
                    ) + 1,
                    d
      ...
      */
        ...
        V.prototype.attributeChangedCallback = function (a) {
          switch (a) {
            case "last-updated":
              ...
              break;
            case "authors":
              this.hasAttribute("authors") &&
                (this.o = this.getAttribute("authors"));
              break;
            case "codelab-title":
        ...
        V.prototype.attributeChangedCallback =
          V.prototype.attributeChangedCallback;
        function Z(a) {
          var c = a.A;
          if (c) {
        ...
        function ra(a) {
          ...
          return new Promise(function (d, e) {
            function f(a) {
              a.done
                ? d(a.value)
                : Promise.resolve(a.value).then(b, c).then(f, e);
            }
            f(a.next());
          });
        }
      ...
      */
        ...
        U.prototype.attributeChangedCallback =
          U.prototype.attributeChangedCallback;
        function ub() {
        ...
        var yb = ma,
          X = [
            "module$exports$googlecodelabs$CodelabAnalytics",
            "injectGAScript",
          ],
          Y = v;
        X[0] in Y ||
      ...
      */
          ...
          if ("label" === a || "step" === a)
            if (
              (this.hasAttribute("label") &&
                (this.s = this.getAttribute("label")),
        ...
        X.prototype.attributeChangedCallback =
          X.prototype.attributeChangedCallback;
        function ob(a) {
          if (!a.w) {
      ...
      (function () {
        ...
        function W(a) {
          return null != a && a.g === U
            ? String(String(a.h).replace(ob, "").replace(pb, "&lt;")).replace(
                qb,
                rb
              )
            : u(String(a));
        ...
        function yb(a) {
          ...
          for (var c = a.length, d = 0; d < c; d++) {
            var e = a[d];
            b +=
              '<div class="survey-question-wrapper"><h4>' + mb(e.v) + "</h4>";
            if (e.options.length) {
      ...
      (function () {
        ...
        var ra = Array.prototype.indexOf
          ...
          sa = Array.prototype.forEach
            ...
            : function (a, b) {
                for (
                  var c = a.length, d = l(a) ? a.split("") : a, e = 0;
                  e < c;
                  e++
                )
        ...
        function wb(a, b, c, d, e, f) {
          if (m(c)) for (var g = 0; g < c.length; g++) wb(a, b, c[g], d, e, f);
            ...
            (b = jb(b, c, d || a.handleEvent, e, f || a.b || a)) &&
              (a.a[b.key] = b);
        }
        function xb(a) {
          Ha(
        ...
        function hc(a) {
          return null != a && a.u === ac
            ? String(String(a.K).replace(ic, "").replace(jc, "&lt;")).replace(
                kc,
                lc
              )
            : t(String(a));
        ...
        function vc(a) {
          ...
          a = a.fa;
          for (
            var c = '<div class="steps"><ol>', d = b.length, e = 0;
            e < d;
            e++
          ) {
            var f = b[e];
        ...
        var Ic = yb(function () {
                  ...
                  if (!(g instanceof M)) {
                    ...
                    for (e in g) {
                      if (!/^[-_a-zA-Z0-9]+$/.test(e))
                        throw Error(
                          "Name allows only [-_a-zA-Z0-9], got: " + e
                        );
                      var x = g[e];
                      null != x &&
          ...
          (b = b && b.dir) &&
            (/^(ltr|rtl|auto)$/i.test(b) ? (c = 0) : (c = null));
          b = P(y, c);
          Bc(a, O(b));
          a = a.firstChild;
      ...
      */
        ...
        W.prototype.attributeChangedCallback =
          W.prototype.attributeChangedCallback;
        ...
        function $c() {
          var a = new URL(document.location.toString()).searchParams.get(
            "index"
          );
          if (!a) return "/";
